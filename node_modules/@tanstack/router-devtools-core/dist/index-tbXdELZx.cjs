  ...
  mount(el) {
    ...
    const dispose2 = render(() => {
      ...
      if (this.#Component) {
        ...
        Devtools = lazy(() => Promise.resolve().then(() => require("./FloatingTanStackRouterDevtools-BuIlKO5O.cjs")));
  ...
  mount(el) {
    ...
    const dispose2 = render(() => {
      ...
      if (this.#Component) {
        ...
        BaseTanStackRouterDevtoolsPanel = lazy(() => Promise.resolve().then(() => require("./BaseTanStackRouterDevtoolsPanel-B-pR5oJv.cjs")).then((n) => n.BaseTanStackRouterDevtoolsPanel$1));
...
//# sourceMappingURL=index-tbXdELZx.cjs.map
