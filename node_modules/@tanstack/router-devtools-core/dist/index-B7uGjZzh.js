  ...
  mount(el) {
    ...
    const dispose2 = render(() => {
      ...
      if (this.#Component) {
        ...
        Devtools = lazy(() => import("./FloatingTanStackRouterDevtools-eWh8pOeT.js"));
  ...
  mount(el) {
    ...
    const dispose2 = render(() => {
      ...
      if (this.#Component) {
        ...
        BaseTanStackRouterDevtoolsPanel = lazy(() => import("./BaseTanStackRouterDevtoolsPanel-B7ouJjNf.js").then((n) => n.c));
...
//# sourceMappingURL=index-B7uGjZzh.js.map
